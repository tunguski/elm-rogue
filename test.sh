...
$ELM test "$P/test/RogueTest.elm" \
  ...
  "$P/src/Rogue/Render.elm" "$P/src/Rogue/Game/Types.elm" "$P/src/Rogue/Game/Appearance.elm" "$P/src/Rogue/Game/Combat.elm" "$P/src/Rogue/Game/Sim.elm" "$P/src/Rogue/Game/MonsterTurn.elm" "$P/src/Rogue/Game/ItemEffects.elm" "$P/src/Rogue/Game/Items.elm" "$P/src/Rogue/Game/Floor.elm" "$P/src/Rogue/Game/Actions.elm" "$P/src/Rogue/Game/Scene.elm" "$P/src/Rogue/Game.elm" "$P/src/Mod/Default.elm"
